...
/**
 * On-demand AI explanation. Explanations are not persisted server-side;
 * each visit can generate a fresh one when AI processing is enabled.
 */
export function AiExplanationPanel({
  ...
  const [current, setCurrent] = useState<GeneratedAi | null>(null);
  ...
  async function generate() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        if (body.error === "ai_processing_disabled") {
          setError("AI processing is disabled. Enable it in Privacy & Compliance Center.");
