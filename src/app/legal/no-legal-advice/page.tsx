export const metadata = {
  title: "No Legal Advice Disclaimer — AccessOps AI",
  description: "maitrico AccessOps AI is not a law firm and does not provide legal advice.",
};
...
export default function NoLegalAdvicePage() {
  return (
    <>
      ...
      <p>
        maitrico is not a law firm. AccessOps AI is a software tool for
