/**
 * Independent accessibility baseline — deliberately NOT using any Percevia
 * code. Raw axe-core via @axe-core/playwright + a few manual DOM metrics.
 * This is the ground truth we compare the Percevia pipeline against.
 */
...
async function run() {
  ...
  try {
    ...
    // Manual DOM metrics (independent of axe & Percevia heuristics).
