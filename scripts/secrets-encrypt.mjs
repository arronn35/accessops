...
const source = resolve(root, process.env.ACCESSOPS_ENV_FILE || ".env.local");
...
const scratchDir = mkdtempSync(join(tmpdir(), "accessops-secrets-"));
const scratchFile = join(scratchDir, "accessops.env");
